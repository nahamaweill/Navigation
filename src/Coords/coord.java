...
public class coord implements coords_converter
{
	 ...
	 * we used the file Excel that was send to use by Boaz.
	 ...
	 * the function calculate the azimuth, the elevation and the distance
	 * we used: https://he.wikipedia.org/wiki/%D7%90%D7%96%D7%99%D7%9E%D7%95%D7%98
	...
	/**
	 * This function verify if this point is a valid lat, lon , alt coordinate: [-180,+180],[-90,+90],[-450, +inf]
	 * @param p 3D point
